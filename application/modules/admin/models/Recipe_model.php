...
class Recipe_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('id_recipe', $q);
	$this->db->or_like('nama_dessert', $q);
	$this->db->or_like('bahan', $q);
	$this->db->or_like('cara', $q);
	$this->db->or_like('gambar_dessert', $q);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2019-07-25 00:02:51 */
/* http://harviacode.com */