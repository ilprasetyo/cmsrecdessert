<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin/user  "><i class="mdi mdi-account"></i><span class="hide-menu">User</span></a>
        </li>
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin/recipe  "><i class="mdi mdi-silverware-variant"></i><span class="hide-menu">Recipe</span></a>
        </li>
        <!-- //BATAS SATU MENU -->
